...
const Newsletter = () => {
  ...
  return (
    <section className="py-16 px-4">
      ...
      >
        <p className="text-xs tracking-[0.3em] uppercase text-primary mb-2">Stay Updated</p>
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-0 border border-border rounded-full overflow-hidden pl-5 pr-1.5 py-1.5 bg-card">
          <input
            type="email"
            value={email}
