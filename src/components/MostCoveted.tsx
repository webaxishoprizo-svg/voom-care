        ...
        {products.map((product, i) => (
          ...
          >
            <div className="relative rounded-xl overflow-hidden aspect-square bg-card mb-3">
              ...
              {/* Add button */}
              <button className="absolute bottom-2.5 right-2.5 z-10 bg-primary text-primary-foreground text-xs font-semibold px-3 py-1.5 rounded-full flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-primary/90">
